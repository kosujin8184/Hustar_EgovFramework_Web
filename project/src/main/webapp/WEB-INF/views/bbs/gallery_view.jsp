	...
	<div class="notice-box">
		<div class="bbs-view">
			...
			<div class="view-hd">
				...
				<h2>갤러리내용 입니다. 열심히 하겠습니다!</h2>
				<p>작성자 : <b>관리자</b></p>
			</div>


			<div class="view-cont">
				<img src="${pageContext.request.contextPath}/img/r01.JPG" alt="커밍순">
				<p>갤러리 작성 후 출력 되는 페이지 입니다.</p>
				<p>갤러리 작성은 textarea로 작성이 되었습니다.</p>
			</div>
		...
		<div class="table-btn">
			<div>
				<a href="<c:url value='/bbs/gallery_list.do'/>" class="lis">목록</a>
